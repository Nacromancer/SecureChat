...
class Window(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.salt = 'hdwuhdfwqhflwj92ue49821ue2uje90du29urn1ro8y:SD":WW{D"WRE#<fojoejq763812uedhyu82h'  #put your own salt here
            ...
            if c != 0:
                ...
                if d == 0:
                    ...
                    if b == 0:
                        ...
                        self.chat_hist_path = '/path/to/SecureChat_hist_' + self.name + '.txt'
